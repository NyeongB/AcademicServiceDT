...
public class MyUtil {
	...
	// 페이지 처리 메소드(GET 방식)
	/*
	 * param: current_page : 현재 표시할 페이지 total_page : 전체페이지수 list_url : 링크를 설정할
	 * url
	 */
	...
	public String pageIndexList(int current_page, int total_page, String list_url, String bid) {
		...
		if (total_page - currentPageSetup > numPerBlock) {
			...
			sb.append("<li><a href='" + list_url + "pageNum=" + total_page + "&bid=" + bid + "'>" + total_page
					+ "</a></li>");
		}
	...
	public String pageIndexList(int current_page, int total_page, String list_url, String bid, String mid) {
		...
		while (page <= total_page && (page <= currentPageSetup + numPerBlock)) {
			if (page == current_page) {
				...
				sb.append("<li><a href='" + list_url + "pageNum=" + page + "&bid=" + bid + "&mid=" + mid + "'>" + page
						+ "</a></li>");
			}
			page++;
		}
		...
		if (total_page - currentPageSetup > numPerBlock) {
			sb.append(
					"<li>[<a href='" + list_url + "pageNum=" + n + "&bid=" + bid + "&mid=" + mid + "'>Next</a>]</li>");
			sb.append("<li><a href='" + list_url + "pageNum=" + total_page + "&bid=" + bid + "&mid=" + mid + "'>"
					+ total_page + "</a></li>");
		}
