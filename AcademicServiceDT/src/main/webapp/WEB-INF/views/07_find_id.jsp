...
<script type="text/javascript">
	...
	function ajaxRequest() {
		...
		alert("인증번호가 발송되었습니다.");
		$.get("telcheck.action", {
			tel : $("#localNum").val() + $("#phoneNumber").val()
		}, function(data) {
			//alert(data);
                     ...
                     <br> -->
						...
						<div class="form-group">
							<label for="phoneNumber"> 핸드폰 번호 </label> <select id="localNum"
								name="num1" class="form-control">
								<option value="010">010</option>
								<option value="011">011</option>
							</select> <input type="text" class="form-control" id="phoneNumber"
								name="num2" placeholder="전화번호" />
							<button type="button" class="btn btn-primary" id="findBtn">인증번호
								받기</button>
						</div>
						<br> <br>
